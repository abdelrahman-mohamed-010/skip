  ...
  return (
    <section className="relative md:min-h-screen py-24 flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-white via-primary/5 to-primary/10">
      <div className="max-w-7xl mx-auto text-center relative">
        ...
        <a
          href="tel:9444754753"
          className="inline-flex items-center px-12 max-sm:px-8 py-3 mt-12 text-lg max-sm:text-base font-medium text-white bg-primary border-2 border-primary hover:bg-white hover:text-primary rounded-full hover:bg-primary/90 transition-colors shadow-lg hover:shadow-xl"
        >
